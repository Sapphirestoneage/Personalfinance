...
- **This lane**: a card's annual fee and the day it posts, warned 45 days out,
  and a dealt walk step folded to one line (D-322); the radar is on the
  Scorecard's Every ratio reading, one drawing (D-323); the menu is on every
  page, the map included, with the twenty arrangements in it (D-324).
