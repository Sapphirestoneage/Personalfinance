...
/* ==========================================================================
   ...
   engine: it is the hand arithmetic below (a band picked by eye from
   data/effective_tax_rates_2026.json, gross times one minus the rate,
...
/* ---- The hand arithmetic ------------------------------------------------
   ...
   `rate` is the effective band I read off data/effective_tax_rates_2026.json
   by hand for this gross and filing status; the band boundary rule there is
   "gross <= upToGrossIncome", so $75,000 single sits in the 0.19 band.   */
function known(spec) {
  const w = [];
  ...
  if (gross !== null && gross !== undefined) {
    ...
    k.effectiveRate = spec.rate;
    const tax = gross * spec.rate;
    ...
    w.push(`gross ${fmt(gross)} ${spec.filingStatus}: band ${spec.band} -> effective rate ${spec.rate}`);
    w.push(`estimated tax = ${fmt(gross)} x ${spec.rate} = ${fmt(tax)}; take-home = ${fmt(gross)} - ${fmt(tax)} = ${fmt(takeHome)} a year, ${fmt(takeHome / 12)} a month`);
    if (fat && gross > 0) {
...
const ARCHETYPES = [
  {
    ...
    filingStatus: 'single', state: 'NC', grossTotal: 48000, rate: 0.16, band: 'single up to $50,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'WI', grossTotal: 62000, rate: 0.19, band: 'single up to $75,000',
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'CA', grossTotal: 210000, rate: 0.24, band: 'married_joint up to $300,000',
  ...
  },
  {
    ...
    filingStatus: 'head_of_household', state: 'OH', grossTotal: 58000, rate: 0.15, band: 'head_of_household up to $65,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'CO', grossTotal: 84000, rate: 0.21, band: 'single up to $100,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'TX', grossTotal: 108000, rate: 0.24, band: 'single up to $150,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'WA', grossTotal: 240000, rate: 0.30, band: 'single up to $300,000',
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'PA', grossTotal: 105000, rate: 0.17, band: 'married_joint up to $130,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'OR', grossTotal: 40000, rate: 0.16, band: 'single up to $50,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'GA', grossTotal: 90000, rate: 0.21, band: 'single up to $100,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'IL', grossTotal: null, rate: null, band: 'no current income source',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'TX', grossTotal: 120000, rate: 0.24, band: 'single up to $150,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'MI', grossTotal: 14000, rate: 0.08, band: 'single up to $15,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'NM', grossTotal: null, rate: null, band: 'no income source (no earned income; portfolio draws are not an income source here)',
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'MO', grossTotal: 95000, rate: 0.17, band: 'married_joint up to $130,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'NJ', grossTotal: 110000, rate: 0.24, band: 'single up to $150,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'MN', grossTotal: 70000, rate: 0.19, band: 'single up to $75,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'VA', grossTotal: 68000, rate: 0.19, band: 'single up to $75,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'MD', grossTotal: 310000, rate: 0.33, band: 'single up to $500,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'AZ', grossTotal: 63400, rate: 0.19, band: 'single up to $75,000',
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'NC', grossTotal: 118000, rate: 0.17, band: 'married_joint up to $130,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'FL', grossTotal: null, rate: null, band: 'no income source yet',
    assets: [], cash: null,
    debts: [], hasDebt: false,
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'TX', grossTotal: 140000, rate: 0.20, band: 'married_joint up to $200,000',
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'MA', grossTotal: 260000, rate: 0.24, band: 'married_joint up to $300,000',
...
const EDGES = [
  {
    ...
    filingStatus: 'single', state: 'NV', grossTotal: 55000, rate: 0.19, band: 'single up to $75,000',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'KS', grossTotal: 0, rate: 0.08, band: 'single up to $15,000 (zero dollars sits in the first band)',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'ME', grossTotal: 800, rate: 0.08, band: 'single up to $15,000',
  ...
  },
  {
    ...
    filingStatus: 'married_joint', state: 'CT', grossTotal: 2400000, rate: 0.33, band: 'married_joint above $500,000 (the open top band)',
  ...
  },
  {
    ...
    filingStatus: 'single', state: 'UT', grossTotal: 75000, rate: 0.19, band: 'single up to $75,000 (the table rule is gross <= band top, so $75,000 exactly stays in the 0.19 band)',
  ...
  },
  {
    ...
    people: [], filingStatus: null, state: null, grossTotal: null, rate: null, band: 'nothing entered',
