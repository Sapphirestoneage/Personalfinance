...
module.exports = function (t) {
  ...
  /* The page now serves three readings with different disciplines, so it
     declares the strictest of them: guarded (D-274). The board itself
  ...
  /* A visible change the merge made, chosen rather than inherited (D-274).
  ...
  /* The Stacker and Exercises are readings of this page since D-274. */
  const exPage = page;
