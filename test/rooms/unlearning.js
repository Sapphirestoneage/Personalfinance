...
module.exports = function (t) {
  ...
  /* The demo persona (shared/demo-persona.js): the ladder stops UNMET on
     ...
     Its banded ratios (engines/ratios.js against ratio_benchmarks v1.3):
       debtToIncome  1,220 owed a month ÷ 6,000 gross a month... the engine
                     reads 0.051 → good (≤ 0.36, D-239: the 28% figure is the
  ...
  check('… housingRatio good, read off the typed roof (D-239)', st.zones.housingRatio, 'good');
  ...
  /* unlearning is a reading of debates since D-272, so this file reads its slice of
