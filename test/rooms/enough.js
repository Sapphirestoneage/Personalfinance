...
module.exports = function (t) {
  ...
  /* -- The room, the row --------------------------------------------------- */
  {
    /* Enough is a reading of The Number since D-285: one multiplication
  ...
  /* -- The page ------------------------------------------------------------------ */
  {
    /* Enough is The Number's enough reading since D-285: its own slice of
    ...
    /* The page serves five readings, so their engines interleave and the
       ...
       is: it is the one that reads what the others defined (D-282). */
