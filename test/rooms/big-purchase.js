...
module.exports = function (t) {
  ...
  check('… and the chips it reads are owned elsewhere', ['cashSavings', 'monthlyExpenses', 'grossAnnualIncome'].map(f => Ownership.field(f).owner).join(','), 'start,expenses,income');
};
