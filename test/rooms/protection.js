...
module.exports = function (t) {
  ...
  /* The page holds a second reading since D-266 (where it goes), which
  ...
  check('… and the coverage facts by The Cushion, where Sleep At Night became a reading (D-232)', ['termLife', 'disabilityMonthly', 'oopMax', 'umbrella'].map(f => Ownership.field(f).owner).join(','), 'runway,runway,runway,runway');
};
