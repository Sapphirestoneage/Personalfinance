...
(function (root, factory) {
  ...
  var ROOMS = [
    ...
    },
    {
      ...
      tier: 1,
      tags: ['debt'],
      daite: { reads: ['debt.items', 'debt.items[].minimumCents'], writes: ['debt.items', 'debt.items[].minimumCents', 'debt.items[].balanceCents', 'debt.items[].rate', 'debt.none'] },
      subsections: [
  ...
  ROOMS.push({
    ...
    order: 98.5,
    title: 'Settings',
    blurb: 'Who you are, and every switch on one screen: what makes the numbers more honest, who is in the household, how far ahead to look, and what a beginner can skip.',
    href: 'rooms/settings.html',
    tier: 0,
    tags: ['income', 'cashflow', 'debt'],
    daite: { reads: [], writes: ['prefs.features', 'you.dependents', 'you.dob', 'you.situation'] },
    subsections: [
  ...
  ROOMS.push({
    ...
    daite: { reads: ['income.grossAnnualCents', 'taxes.filingStatus', 'taxes.state'], writes: ['taxes.filingStatus', 'taxes.otherPreTax', 'taxes.state', 'taxes.withheld', 'taxes.zip'] },
      subsections: [
        ...
        { id: 'inputs',      label: 'Filing, state, and what is pre-tax' },
        { id: 'amounts',     label: 'Through the lens' },
        { id: 'assumptions', label: 'Assumptions' },
        { id: 'reading',     label: 'What this reads' }
      ]
