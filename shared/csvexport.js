...
(function (root, factory) {
  ...
  function line(r, it, v, st, meta, h, ns) {
    return { raw: v === undefined ? null : v, kind: r.kind, door: r.door, level: r.level, row: r.id, label: r.label, item: itemName(it), institution: (it && it.institution) || '', value: valueText(r, v), unit: r.unit, state: stateWord(st, ns),
