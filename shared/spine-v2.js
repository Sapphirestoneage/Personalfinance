/* ==========================================================================
   ...
   API surface (stable, per SPEC.md §1):
       ...
       registerRoom(id)        -> mark a room visited; notes the day (D-251)
...
(function (root, factory) {
  ...
  /* ---- Example numbers, and saying so (D-251) ----------------------------
   ...
   * before D-251 has an unknown history, not an empty one.
   */
