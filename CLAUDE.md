...
- Exception (D-339, D-340): `coach/` and `safeword/` are separate apps (like `dnd/`),
  each with its own tests and log (`coach/README.md`, `safeword/README.md`).
  Nothing outside that folder changes for either.
