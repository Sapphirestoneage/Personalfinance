/* ==========================================================================
   engines/quickentry.js, a line of shorthand into Ledger rows. D-340.
   --------------------------------------------------------------------------
   The coach types while the client talks:
       car 450/mo 5.9% 38 left      rent 2100
       401k 38k match 4%            hysa 12.5k
   and this reads the line into a PLAN: which Ledger rows it writes, with
   what, and a one-line preview in words. It never writes; the console
   saves the plan through Ownership (shared/coach.js applyQuick).
