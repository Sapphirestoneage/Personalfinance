...
(function (root, factory) {
  ...
  var api = factory(deps.Money, deps.Schema, deps.Expr, deps.Tier0, deps.Projection, deps.Statement, deps.Rerank, deps.CashFlow, deps.Hourly, deps.SelfEmployed, deps.Tax, deps.Debt, deps.QuickMath, deps.VPW, deps.SocialSecurity);
  if (typeof module === 'object' && module.exports) { module.exports = api; }
  if (root) { root.SLAF = root.SLAF || {}; root.SLAF.Events = api; }
})(typeof self !== 'undefined' ? self : null, function (Money, Schema, Expr, Tier0, Projection, Statement, Rerank, CashFlow, Hourly, SelfEmployed, Tax, Debt, QuickMath, VPW, SocialSecurity) {
  'use strict';
  ...
  function evaluate(x, env) {
    return Expr.evaluate(x, env.fn ? env : Object.assign({}, env, { fn: callFn }));
  }
