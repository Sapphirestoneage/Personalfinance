---
description: Orient at the start of a session without reading the archives
---
Read `STATUS.md` and `docs/ARCHITECTURE.md`, and nothing else yet.

Run `git log --oneline -10` and `node tools/context/build.js --check`. If the
