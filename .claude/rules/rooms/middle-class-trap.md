...
File: rooms/middle-class-trap.html · 203 lines
Engines: selfemployed, tax, projection, tier0, income, ledger, trap
...
Owns: nothing
Reads from other owners: filingStatus (start), retireAge (fire)
Latest decisions:
...
Full context: node tools/context/pack.js middle-class-trap
