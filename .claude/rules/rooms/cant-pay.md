...
File: rooms/cant-pay.html · 529 lines
Engines: projection, tier0, cashflow
Reference data: bill_triage.json, effective_tax_rates_2026.json, expense_categories.json
Owns: nothing
Reads from other owners: filingStatus (tax), grossAnnualIncome (income), cashSavings (statement), monthlyDebtPayments (debt-payoff), monthlyExpenses (expenses)
Latest decisions:
