...
Reads from other owners: grossAnnualIncome (start), cashSavings (start), employmentStatus (settings), employerMatch (start), hasDebt (debt-payoff), mortgageRate (housing), monthlyExpenses (expenses)
Latest decisions:
