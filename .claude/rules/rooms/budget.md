...
---
# Budget (`budget`)
File: rooms/budget.html · 483 lines
Engines: projection, tier0, income, selfemployed, ledger, cashflow, quickmath, presets, budget
Reference data: budget_templates.json, car_costs.json, effective_tax_rates_2026.json, expense_categories.json, irs_limits_2026.json, savings_presets.json, +2 more
Owns: monthsClosed
