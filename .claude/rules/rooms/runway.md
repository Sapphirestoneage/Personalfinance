...
---
# The Cushion (`runway`)
File: rooms/runway.html · 1742 lines
...
Owns: unemployment, lastPay, highestDeductible, oopMax, termLife, disabilityMonthly, umbrella, expectedSearchMonths, floorMonthly, swanTarget
Reads from other owners: grossAnnualIncome (income), cashSavings (statement), employmentStatus (settings), healthCover (protection), healthMonthly (protection), monthlyExpenses (expenses)
Latest decisions:
