...
Reads from other owners: grossAnnualIncome (start), cashSavings (start), employmentStatus (settings), highestDeductible (start), healthCover (protection), healthMonthly (protection), monthlyExpenses (expenses)
Latest decisions:
