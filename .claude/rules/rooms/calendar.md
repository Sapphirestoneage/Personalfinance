...
File: rooms/calendar.html · 268 lines
...
Reads from other owners: grossAnnualIncome (start), takeHomeMonthly (first-look), cashSavings (start), rentMonthly (expenses), monthlyDebtPayments (debt-payoff), monthlyExpenses (expenses)
Latest decisions:
