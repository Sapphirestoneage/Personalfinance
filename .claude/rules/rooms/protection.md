...
Reads from other owners: grossAnnualIncome (income), cashSavings (start), highestDeductible (runway), oopMax (runway), termLife (runway), disabilityMonthly (runway), monthlyExpenses (expenses)
Latest decisions:
