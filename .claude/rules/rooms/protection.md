...
Reads from other owners: grossAnnualIncome (income), cashSavings (statement), highestDeductible (runway), oopMax (runway), termLife (runway), disabilityMonthly (runway), monthlyExpenses (expenses)
Latest decisions:
