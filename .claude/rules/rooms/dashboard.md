...
Owns: nothing
Reads from other owners: filingStatus (tax), grossAnnualIncome (start), cashSavings (start), capturingFullMatch (start), hasDebt (debt-payoff), totalDebt (debt-payoff), netWorth (statement), retireAge (fire), +1 more
Latest decisions:
