...
Owns: nothing
Reads from other owners: filingStatus (tax), grossAnnualIncome (income), cashSavings (statement), capturingFullMatch (accounts), hasDebt (debt-payoff), totalDebt (debt-payoff), netWorth (statement), retireAge (fire), +1 more
Latest decisions:
