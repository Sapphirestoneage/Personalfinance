...
Owns: nothing
Reads from other owners: filingStatus (tax), cashSavings (statement), capturingFullMatch (accounts), totalDebt (debt-payoff), otherAssets (statement), netWorth (statement)
Latest decisions:
  - D-213 — I1, I3, I4, I5: Money Wrapped, the rank guess, the coast date, the Unlearning Quiz
Full context: node tools/context/pack.js wrapped
