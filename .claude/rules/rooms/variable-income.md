...
File: rooms/variable-income.html · 291 lines
...
Reads from other owners: grossAnnualIncome (income), cashSavings (statement), ledgerIncome (income), monthlyExpenses (expenses)
Latest decisions:
