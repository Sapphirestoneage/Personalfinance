...
File: rooms/reversibility.html · 332 lines
Engines: projection, tier0, income, selfemployed, ledger, cashflow, hourly, events, reversibility
Reference data: effective_tax_rates_2026.json, expense_categories.json, housing_conventions.json, moving_cost.json, reentry_gap.json, reversibility.json, +2 more
