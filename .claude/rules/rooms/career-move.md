...
---
# Work (`career-move`)
File: rooms/career-move.html · 2006 lines
...
Reads from other owners: filingStatus (start), grossAnnualIncome (start), takeHomeMonthly (ledger), employmentStatus (start), employerMatch (start), marginalRate (statement), healthMonthly (protection), retireAge (fire), +1 more
Latest decisions:
