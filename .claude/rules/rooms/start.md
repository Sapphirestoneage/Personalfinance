...
Owns: grossAnnualIncome, unemployment, lastPay, cashSavings, investments, employerMatch, capturingFullMatch, hasDebt, contributionPercent, highestDeductible
Reads from other owners: filingStatus (tax), employmentStatus (settings), totalDebt (debt-payoff), monthlyDebtPayments (debt-payoff), monthlyExpenses (expenses), debtBalance (debt-payoff), debtRate (debt-payoff), paySurvives (income)
Latest decisions:
