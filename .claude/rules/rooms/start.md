...
Owns: dob, age, grossAnnualIncome, unemployment, lastPay, cashSavings, investments, employmentStatus, employerMatch, capturingFullMatch, hasDebt, contributionPercent, highestDeductible, dependents
Reads from other owners: filingStatus (tax), totalDebt (debt-payoff), monthlyDebtPayments (debt-payoff), monthlyExpenses (expenses), debtBalance (debt-payoff), debtRate (debt-payoff), paySurvives (income)
Latest decisions:
