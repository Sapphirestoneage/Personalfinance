...
Owns: nothing
Reads from other owners: grossAnnualIncome (start), takeHomeMonthly (first-look), lastPay (start), cashSavings (start), employmentStatus (start), contributionPercent (start), partnerDob (partner), totalDebt (debt-payoff), +17 more
Latest decisions:
