...
Owns: nothing
Reads from other owners: grossAnnualIncome (income), lastPay (runway), cashSavings (start), employmentStatus (settings), contributionPercent (accounts), partnerDob (partner), totalDebt (debt-payoff), otherAssets (statement), +16 more
Latest decisions:
