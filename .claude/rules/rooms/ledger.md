...
Owns: nothing
Reads from other owners: grossAnnualIncome (start), lastPay (start), cashSavings (start), employmentStatus (settings), contributionPercent (start), partnerDob (partner), totalDebt (debt-payoff), otherAssets (statement), +16 more
Latest decisions:
