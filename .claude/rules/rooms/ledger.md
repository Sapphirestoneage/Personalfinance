...
---
# The Ledger (`ledger`)
File: rooms/ledger.html · 3555 lines · utility room
...
Reference data: access_rules.json, confidence_weights.json, debt_rules.json, effective_tax_rates_2026.json, expense_categories.json, fire_variants.json, +18 more
