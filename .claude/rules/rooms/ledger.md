...
Owns: nothing
Reads from other owners: grossAnnualIncome (income), lastPay (runway), cashSavings (statement), employmentStatus (settings), contributionPercent (accounts), partnerDob (partner), totalDebt (debt-payoff), otherAssets (statement), +16 more
Latest decisions:
