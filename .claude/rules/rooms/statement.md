...
Reads from other owners: filingStatus (tax), grossAnnualIncome (start), cashSavings (start), marginalRate (accounts), highestDeductible (runway), oopMax (runway), totalDebt (debt-payoff), futureIncome (timeline), +1 more
Latest decisions:
