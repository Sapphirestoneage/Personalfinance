...
Reads from other owners: filingStatus (tax), grossAnnualIncome (income), cashSavings (start), marginalRate (accounts), highestDeductible (runway), oopMax (runway), totalDebt (debt-payoff), futureIncome (timeline), +1 more
Latest decisions:
