...
File: rooms/statement.html · 723 lines
Engines: projection, tier0, fire, selfemployed, tax, statement, income, ledger, cashflow, quickmath, presets, budget
Reference data: access_rules.json, car_costs.json, effective_tax_rates_2026.json, expense_categories.json, fire_variants.json, savings_presets.json, +1 more
