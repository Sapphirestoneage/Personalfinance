...
File: rooms/statement.html · 733 lines
...
Owns: cashSavings, investments, otherAssets, confidenceWeightedNetWorth, netWorth, assetValue, assetCharacter, assetTier, assetCostBasis
Reads from other owners: filingStatus (tax), grossAnnualIncome (income), marginalRate (accounts), highestDeductible (runway), oopMax (runway), totalDebt (debt-payoff), futureIncome (timeline), monthlyExpenses (expenses)
Latest decisions:
