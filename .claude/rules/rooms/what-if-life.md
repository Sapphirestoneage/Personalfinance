...
Owns: nothing
Reads from other owners: grossAnnualIncome (income), cashSavings (statement), contributionPercent (accounts), totalDebt (debt-payoff), netWorth (statement), retireAge (fire), monthlyExpenses (expenses)
Latest decisions:
