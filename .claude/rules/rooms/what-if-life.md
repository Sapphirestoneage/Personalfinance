...
Owns: nothing
Reads from other owners: grossAnnualIncome (income), cashSavings (start), contributionPercent (accounts), totalDebt (debt-payoff), netWorth (statement), retireAge (fire), monthlyExpenses (expenses)
Latest decisions:
