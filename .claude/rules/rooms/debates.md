...
Reads from other owners: grossAnnualIncome (start), takeHomeMonthly (ledger), cashSavings (start), employmentStatus (start), employerMatch (start), hasDebt (start), marginalRate (ledger), rentMonthly (expenses), +4 more
Latest decisions:
