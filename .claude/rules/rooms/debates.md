...
---
# The Referee (`debates`)
File: rooms/debates.html · 149 lines
...
Owns: nothing
Reads from other owners: filingStatus (start), marginalRate (accounts), rentMonthly (expenses), retireAge (fire), monthlyExpenses (expenses), debtRate (debt-payoff)
Latest decisions:
