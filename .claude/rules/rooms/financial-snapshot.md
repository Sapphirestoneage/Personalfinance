...
Owns: nothing
Reads from other owners: filingStatus (tax), grossAnnualIncome (start), cashSavings (start), employerMatch (start), capturingFullMatch (start), totalDebt (debt-payoff), monthlyDebtPayments (debt-payoff), netWorth (statement), +2 more
Latest decisions:
