...
Owns: nothing
Reads from other owners: filingStatus (start), grossAnnualIncome (start), takeHomeMonthly (first-look), cashSavings (start), employerMatch (start), capturingFullMatch (start), totalDebt (debt-payoff), monthlyDebtPayments (debt-payoff), +3 more
Latest decisions:
