...
Owns: nothing
Reads from other owners: filingStatus (tax), grossAnnualIncome (income), cashSavings (start), employerMatch (accounts), capturingFullMatch (accounts), totalDebt (debt-payoff), monthlyDebtPayments (debt-payoff), netWorth (statement), +2 more
Latest decisions:
