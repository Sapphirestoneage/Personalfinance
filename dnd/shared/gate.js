...
(function (root, factory) {
  ...
  var BRANCHES = {
    ...
    /* Two different questions shared one key. "What am I drawing?" is a
       fact about a retiree and rightly gates the withdrawal-rate reading.
       "Could I stop, and what would it look like?" is asked BEFORE you go —
       by the people at or near their number working out whether they can.
       Gating the ROOM on the first meant it opened only once the decision
       was irreversible, and told everyone else "not for you right now, you
       said you are employed". D-225. */
    drawdownPlanning: function (h, s) { return s !== 'student'; },
  ...
  var WHY = {
    ...
    drawdownPlanning: 'This one is about drawing down what you built. A student has not built it yet.',
