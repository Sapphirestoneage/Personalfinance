...
shared/             The spine everything depends on
  ...
  workbook.js         the whole app as one spreadsheet: all 97 rows on a tab for their door, asked in plain words with the five sentences beside them, every derived figure a live formula over named cells, and a tab of readings; built from data/workbook.json, tied to the engines by test/workbook.js (D-356)
