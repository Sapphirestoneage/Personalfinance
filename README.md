...
site/               Stress Less About Money, the coaching site: the landing, Coaching, Book, About Eli, and the free tools (the number, how FIRE works, the glossary, every room). Its own app and tests (D-340, site/README.md)
